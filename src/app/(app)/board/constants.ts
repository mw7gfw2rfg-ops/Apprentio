...
export const BOARD_COLUMNS = [
  ...
  { key: "approved", label: "Approved", dot: "bg-indigo-500 dark:bg-indigo-400", stages: ["approved"] },
  { key: "submitted", label: "Submitted", dot: "bg-indigo-500 dark:bg-indigo-400", stages: ["submitted"] },
