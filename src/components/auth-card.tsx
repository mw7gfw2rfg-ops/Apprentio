...
export function AuthCard({
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(900px_520px_at_12%_-6%,var(--warm-sage)_0%,transparent_60%),radial-gradient(760px_460px_at_96%_4%,var(--warm-sky)_0%,transparent_62%)] bg-background px-4 py-16">
